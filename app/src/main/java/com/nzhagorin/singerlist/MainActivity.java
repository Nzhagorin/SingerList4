    ...
    class GetContentToDevice extends AsyncTask<String,Integer,Integer>{
        ...
        protected Integer doInBackground(String... params) {
            ...
            try {
                ...
                for (Integer i=0;i<whole.length();i++){
                    ...
                    String tracks = itemList.getString("tracks");
                    String aldums = itemList.getString("albums");
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            while(getItemSinger<=mRecyclerView.getChildCount()){
                ...
                Toast.makeText(getApplicationContext(),"ОМГ",Toast.LENGTH_SHORT).show();
                try {
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(getApplicationContext(),"это позиция №"+position, Toast.LENGTH_SHORT).show();
